...
import library.lgq.javabean.User_book;
...
public class QuerybookInfo extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			List<User_book> list=new User_bookBean().queryBookinfoByuser(username);
			if(list!=null){
				for(int i=0;i<list.size();i++){
					...
					jsonObject.put("enddate", list.get(i).getEnd_date());
