...
public class UpdateBorrowbookCount extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public UpdateBorrowbookCount() {
		super();
	}
...
//借书的时候修改借书的数量
		...
		try {
			int res=new BookBean().UpdateBorrowCount(username);
			if(res==1){
				System.out.println("lgq----修改借书的数量成功");
